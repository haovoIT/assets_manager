...
class PdfLSSDApi {
  static Future<File> generate(List<LichSuSuDung> list,String email,String name) async {
  ...
  static pw.Widget buildTable(List<LichSuSuDung> list, int index) {
    final headers = [
      'STT',
      'Tên Tài Sản',
      'Phòng Ban',
