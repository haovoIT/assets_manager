...
//định dạng đối với tiền việt nam không có hệ số thâp phân
class MoneyMaskedTextControllerA extends TextEditingController {
  MoneyMaskedTextControllerA(
      {double initialValue = 0.0, this.thousandSeparator = '.'}) {
    this.addListener(() {
...
//định dạng đối với nhiều loại tiền tệ, có hệ số thâp phân
class MoneyMaskedTextControllerB extends TextEditingController {
  MoneyMaskedTextControllerB(
